...
public class CA extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            response.getWriter().write("<h1>Animal criada com sucesso!</h1>");
            response.getWriter().write("<p>Nome: " + nome + "</p>");
            response.getWriter().write("<p>Data de Nascimento: " + datanasc + "</p>");
            response.getWriter().write("<p>Foto: " + foto + "</p>");
            response.getWriter().write("<p>Doado: " + doado + "</p>");
            response.getWriter().write("<p>Idade: " + idade + "</p>");
            ...
            response.sendError(HttpServletResponse.SC_INTERNAL_SERVER_ERROR, "Erro ao salvar a animal");
        }
    }
}
